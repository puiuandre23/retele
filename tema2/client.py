...
while True:
    ...
    if comanda == 'EXIT':
        ...
        if not este_conectat:
            print("EROARE: Trebuie sa te conectezi inainte de PUBLISH.")
            continue

        if argumente.strip() == '':
            print("EROARE: Trebuie sa scrii un mesaj dupa PUBLISH.")
            continue
        ...
        if not este_conectat:
            print("EROARE: Trebuie sa te conectezi inainte de DELETE.")
            continue

        if argumente.strip() == '':
            print("EROARE: Trebuie sa scrii ID-ul dupa DELETE.")
            continue

        if not argumente.strip().isdigit():
            print("EROARE: ID-ul trebuie sa fie numar intreg.")
            continue
        ...
        if not este_conectat:
            print("EROARE: Trebuie sa te conectezi inainte de LIST.")
            continue
